...
final class DoughCell: UITableViewCell {
    ...
    static let reuseID = "DoughCell"
    
    private lazy var doughSegmentControl: UISegmentedControl = {
...
private extension DoughCell {
    
    func setupViews() {
        contentView.addSubview(doughSegmentControl)
    }
